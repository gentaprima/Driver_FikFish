...
public class DataShipping implements Parcelable {
    ...
    @Expose
    private Boolean status_shipping;

    public Boolean getStatus_shipping() {
        return status_shipping;
    }

    public void setStatus_shipping(Boolean status_shipping) {
    ...
    protected DataShipping(Parcel in) {
    ...
    public static final Parcelable.Creator<DataShipping> CREATOR = new Parcelable.Creator<DataShipping>() {
        @Override
        public DataShipping createFromParcel(Parcel source) {
            return new DataShipping(source);
        }

        @Override
        public DataShipping[] newArray(int size) {
            return new DataShipping[size];
        }
    };
}
