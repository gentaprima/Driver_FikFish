...
public class ChangeStatusDelayRepository  {
    private ApiInterface apiInterface;

    public ChangeStatusDelayRepository(){
        apiInterface = ApiClient.getClient().create(ApiInterface.class);
    }

    public MutableLiveData<MessageOnly> changeStatusDelay(String id_shipping){
        final MutableLiveData<MessageOnly> mutableLiveData = new MutableLiveData<>();
        Call<MessageOnly> requestOrder = apiInterface.changeStatusDelay(id_shipping);
